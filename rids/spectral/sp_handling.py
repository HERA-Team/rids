    ...
    def raw_data_plot(self, rid, feature_components, plot_type='waterfall', f_range=None, t_range=None,
        ...
        for fc in feature_components:
            ...
            for fs in time_keys:
                ...
                ts, x = _get_duration_in_std_units(ts, use_unit=ts_unit)
            ...
            dur[fc]['t'].lo = _get_duration_in_std_units((t_lo - t0).total_seconds(), use_unit=ts_unit)[0]
            dur[fc]['t'].hi = _get_duration_in_std_units((t_hi - t0).total_seconds(), use_unit=ts_unit)[0]
