...
description = "rids: RF Interference Data System"
# Long description will go up on the pypi page
long_description = """
rids
========
RF Interference Data System
To get started using these components in your own software, please go to the
repository README
License
=======
``rids`` is licensed under the terms of the BSD license. See the file
...
URL = "https://github.com/david-deboer/rids"
DOWNLOAD_URL = ""
LICENSE = "BSD"
AUTHOR = "HERA Team"
...
VERSION = __version__
PACKAGES = ['rids', 'rids.spectrum_peak', 'rids.tests']
