...
if __name__ == '__main__':
    ...
    if args.stack is not None:
        s.raw_data_plot(r, args.stack, plot_type='stack', f_range=args.f_range, t_range=args.t_range, legend=args.legend)
    if args.stream is not None:
        s.raw_data_plot(r, args.stream, plot_type='stream', f_range=args.f_range, t_range=args.t_range, legend=args.legend)
    plt.show()
