...
ap.add_argument('--wf', help="plot reconstituted data feature components as waterfall in that file ('val', 'maxhold', or 'minhold')", default=None)
ap.add_argument('--stack', help="plot reconstituted data feature components as stack in that file ( '' or csv list)", default=None)
ap.add_argument('--stream', help="plot reconstituted data as time streams in that file ( '' or csv list)", default=None)
...
if __name__ == '__main__':
    ...
    r.reader(args.file)
    s = features.sp_handling_recon.SPHandling()
#FIX ALL BELOW
    if args.wf is not None:
